var dashboardApp = new Vue({
  ...
  methods: {
    ...
    fetchTasks () {
      fetch('https://github.com/jegerard/D-S-Files/blob/master/app/data/p1-tasks.json')
    ...
    fetchProject () {
      fetch('https://github.com/jegerard/D-S-Files/blob/master/app/data/project1.json')
      .then( response => response.json() )
